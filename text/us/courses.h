COURSE_ACTS(COURSE_BOB, _(" 1 LA BATALLA CON BOB-OMB"),
       _("GRAN BOB-OMB EN LA CIMA")     , _("CARRERA CON KOPPA EL VELOZ") , _("DISPARATE A LA ISLA FLOTANTE"),
       _("ENCUENTRA LAS MONEDAS ROJAS")          , _("MARIO VUELA EN EL MUNDO")        , _("LIBERA A CHAIN CHOMP'S"))

COURSE_ACTS(COURSE_WF, _(" 2 LA FORTALEZA WHOMP'S"),
       _("ACABA CON EL REY WHOMP'S")        , _("EN LA CIMA DE LA FORTALEZA")    , _("DISPARATE POR LA ESTRELLA"),
       _("BUSCA LAS MONEDAS ROJAS"), _("CAE EN LA JAULA FLOTANTE")    , _("ROMPE LOS MUROS ALTOS"))
